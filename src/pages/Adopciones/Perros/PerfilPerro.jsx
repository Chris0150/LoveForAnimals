...
import dogAdoption1 from '../../../assets/images/dogs/adoptionDog1.jpg';
import dogAdoption2 from '../../../assets/images/dogs/adoptionDog2.jpg';
import dogAdoption3 from '../../../assets/images/dogs/adoptionDog3.jpg';
...
class AdopcionGatos extends React.Component {
  ...
  render() {
    ...
    aTabs.push(
      <div style={{margin : 20}}>
        <Typography variant="caption" display="block" gutterBottom>Nombre: Lana</Typography>
        <Typography variant="caption" display="block" gutterBottom>Fecha de Nacimiento: 22/10/19</Typography>
        <Typography variant="caption" display="block" gutterBottom>Raza: Pastor Alemán</Typography>
        <Typography variant="caption" display="block" gutterBottom>Peso: 5kg</Typography>
    ...
    aTabs.push(
      <div style={{margin : 20}}>
        <Typography variant="caption" display="block" gutterBottom>
          Esta simpática perrita fué abandonada junto con dos hermanitas más
    ...
    return (
      <div>
        <NavBar handleNavBack={this.handleNavBack} title="Perfil Perro" />
        <Carousel
          showFooter={false}
          showLegend={false}
          showRating={false}
          ...
          slide2={dogAdoption2}
          slide3={dogAdoption3}
          slide4={"https://www.youtube.com/embed/hjJrNA7gdrU"}
          axis="horizontal">
        </Carousel>
        <TabPanel
          tab1="Ficha"
