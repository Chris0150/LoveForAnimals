...
class MiPerro extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    let aPerfil = [];
    aPerfil.push([{ field: "Nombre:" }, { field: "Luna" }]);
    aPerfil.push([{ field: "Fecha de Nacimiento:" }, { field: "22/01/2015" }]);
    aPerfil.push([{ field: "Raza:" }, { field: "Pastor Alemán" }]);
    aPerfil.push([{ field: "Peso:" }, { field: "31 Kg" }]);
    ...
    return (
      <div>
        <NavBar handleNavBack={this.handleNavBack} title="Luna Perfil" />
        <img alt="" src={profileDog} style={{ width: "100%" }} />
...
export default connect(mapStateToProps, mapDispatchToProps)(MiPerro);
